  ...
  return <div className='bg-primary/60 h-full'>
    ...
    <div className='w-full h-full bg-gradient-to-r from-primary/10 via-black/30'>
      <div className='text-center flex flex-col justify-center xl:pt-30 xl:text-left h-full container mx-auto'>
        ...
        {}
        <motion.p variants={fadeIn('down',0.3)} initial='hidden' animate='show' exit='hidden' className='max-w-sm xl:max-w-xl mx-auto xl:mx-0 mb-10 xl:mb-16'>Highly skilled and innovative Software Developer and Full Stack developer with a proficient in designing and developing dynamic and user-friendly websites.</motion.p>
        {}
